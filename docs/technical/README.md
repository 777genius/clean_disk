...
| designing growing tree live scan updates | [Growing tree streaming architecture](growing-tree-streaming-architecture.md) | partial-node event model, authority boundaries, capability gate, pdu replacement path, and UI semantics |
...
| [Growing tree streaming architecture](growing-tree-streaming-architecture.md) | P1-P3 | Decision | live partial-node scan updates, capability gate, authority boundary, adapter replacement path, and UI semantics |
